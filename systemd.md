...
target unit | Replaces init run levels. This is used to group other units when defining unit dependencies,
or to provide a timing synchronization point when defining order relationships. | .target
...
device unit | When udev recognizes a new device, the associated unit is defined and
activated automatically. This is automatically generated by udev. | .device
